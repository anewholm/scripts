...
use Acorn\CreateSystem\Semantic\Field;
...
HTML
    ...
    {
        if (file_exists('.env')) return new static($cwd, $scriptDirPath);
        return NULL;
    }
}

Framework::registerDetector(WinterCMS::class);
Table::registerKnownAcornPlugins(['User', 'Location', 'Messaging', 'Calendar', 'Reporting', 'BackendLocalization', 'Rtler']);
Table::registerKnownWinterPlugins(['System', 'Backend']);
