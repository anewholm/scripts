...
class Table {
    ...
    protected static array $knownAcornPlugins = [];
    protected static array $knownWinterPlugins = [];

    public static function registerKnownAcornPlugins(array $plugins): void
    {
        self::$knownAcornPlugins = array_merge(self::$knownAcornPlugins, $plugins);
    }

    public static function registerKnownWinterPlugins(array $plugins): void
    {
        self::$knownWinterPlugins = array_merge(self::$knownWinterPlugins, $plugins);
    }
