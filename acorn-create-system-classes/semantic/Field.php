...
class Field {
    ...
    public $debugComment;
    public $fieldComment;
    public ?string $isPattern = NULL; // ISPattern::* constant — semantic IS pattern for this field
    ...
    protected static function create(Model $model, array $fieldDefinition, Column|NULL $column, array $relations): Field
    {
        ...
        if ($field->isPattern === NULL) {
            $field->isPattern = ISPattern::inferFromField($field, $column, $relations);
        }
