...
use Acorn\CreateSystem\Semantic\Relation1to1;
use Acorn\CreateSystem\Semantic\RelationHasManyDeep;
    ...
    public function fields(int $recursing = 0): array
    {
                                ...
                                if (!$recursing) {
                                    ...
                                    foreach ($relation1to1Fields as $subFieldName => $subFieldObj) {
                                        ...
                                        if (   !$isSpecialField
                                            ...
                                            $subFieldObj->isPattern     = ISPattern::HAS_MANY_DEEP_SORTABLE;
                                ...
                                if (!$relation1to1 instanceof RelationHasManyDeep) {
                                    ...
                                    foreach ($relation1to1Fields as $subFieldName => $subFieldObj) {
                                        ...
                                        if (   !$isSpecialField
                                            ...
                                            $subFieldObj->nested     = TRUE;
                                            $subFieldObj->isPattern  = ISPattern::EMBEDDED_1TO1;
        ...
        */
        ...
        foreach ($fields as $name => &$field) {
            ...
            if ($field->tabLocation == 1 && !$field->tab)
                throw new Exception("[$field->name] tab-location: 1 is not valid. Use tab: <translation key> instead");
